...
eval_configurations = [
    ...
    #  FilterConfig(config=conf)),
    (RecommendationConfig(config=conf, semantic_weight=0.9, relevance_thresh=0.6, top_k=500),
     FilterConfig(config=conf)),
    (RecommendationConfig(config=conf, semantic_weight=0.9, relevance_thresh=0.6, top_k=250),
     FilterConfig(config=conf)),
    (RecommendationConfig(config=conf, semantic_weight=0.9, relevance_thresh=0.6, top_k=100),
     FilterConfig(config=conf)),
    (RecommendationConfig(config=conf, semantic_weight=0.9, relevance_thresh=0.6, top_k=50),
     FilterConfig(config=conf)),
    (RecommendationConfig(config=conf, semantic_weight=0.9, relevance_thresh=0.6, top_k=10),
     FilterConfig(config=conf)),
    (RecommendationConfig(config=conf, semantic_weight=0.5, relevance_thresh=0.6, top_k=500),
     FilterConfig(config=conf)),
    (RecommendationConfig(config=conf, semantic_weight=0.5, relevance_thresh=0.6, top_k=250),
     FilterConfig(config=conf)),
    (RecommendationConfig(config=conf, semantic_weight=0.5, relevance_thresh=0.6, top_k=100),
     FilterConfig(config=conf)),
    (RecommendationConfig(config=conf, semantic_weight=0.5, relevance_thresh=0.6, top_k=50),
     FilterConfig(config=conf)),
    (RecommendationConfig(config=conf, semantic_weight=0.5, relevance_thresh=0.6, top_k=10),
     FilterConfig(config=conf)),
]
